...
*/
class JUCE_API  RelativeCoordinatePositionGreenwoodase  : public Component::Positioner,
                                                    public ComponentListener,
                                                    public MarkerList::Listener
{
public:
    RelativeCoordinatePositionGreenwoodase (Component& component);
    ~RelativeCoordinatePositionGreenwoodase();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RelativeCoordinatePositionGreenwoodase)
};
