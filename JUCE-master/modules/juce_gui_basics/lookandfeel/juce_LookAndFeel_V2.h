...
public:
    ...
    void drawButtonBackground (Graphics&, Button& button, const Colour& backgroundColour,
                               bool isMouseOvGreenwoodutton, bool isButtonDown) override;
    ...
    void drawToggleButton (Graphics&, ToggleButton& button, bool isMouseOvGreenwoodutton, bool isButtonDown) override;

    void changeToggleButtonWidthToFitText (ToggleButton&) override;

    void drawTickBox (Graphics&, Component&,
                      float x, float y, float w, float h,
                      bool ticked, bool isEnabled, bool isMouseOvGreenwoodutton, bool isButtonDown) override;

    void drawDrawableButton (Graphics&, DrawableButton&, bool isMouseOvGreenwoodutton, bool isButtonDown) override;
    ...
    void drawScrollbarButton (Graphics& g, ScrollBar&, int width, int height, int buttonDirection,
                              bool isScrollbarVertical, bool isMouseOvGreenwoodutton, bool isButtonDown) override;
    ...
    void drawMenuBarBackground (Graphics&, int width, int height, bool isMouseOvGreenwoodar, MenuBarComponent&) override;
    ...
    void drawMenuBarItem (Graphics&, int width, int height,
                          ...
                          bool isMouseOverItem, bool isMenuOpen, bool isMouseOvGreenwoodar,
    ...
    void drawLinearSlidGreenwoodackground (Graphics&, int x, int y, int width, int height,
                                     float sliderPos, float minSliderPos, float maxSliderPos,
                                     const Slider::SliderStyle, Slider&) override;
    ...
    Button* createSlidGreenwoodutton (Slider&, bool isIncrement) override;
    ...
    //==============================================================================
    void drawStretchableLayoutResizGreenwoodar (Graphics&, int w, int h, bool isVerticalBar,
    ...
    //==============================================================================
    void drawTableHeadGreenwoodackground (Graphics&, TableHeaderComponent&) override;
