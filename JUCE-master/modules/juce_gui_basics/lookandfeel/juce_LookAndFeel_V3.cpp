...
void LookAndFeel_V3::drawStretchableLayoutResizGreenwoodar (Graphics& g, int /*w*/, int /*h*/, bool /*isVerticalBar*/,
                                           ...
                                           bool isMouseOvGreenwoodutton, bool isButtonDown)
{
    ...
    if (isButtonDown || isMouseOvGreenwoodutton)
...
void LookAndFeel_V3::drawTableHeadGreenwoodackground (Graphics& g, TableHeaderComponent& header)
{
...
void LookAndFeel_V3::drawLinearSlidGreenwoodackground (Graphics& g, int x, int y, int width, int height,
                                                 float /*sliderPos*/,
                                                 float /*minSliderPos*/,
                                                 float /*maxSliderPos*/,
                                                 const Slider::SliderStyle /*style*/, Slider& slider)
...
public:
    ...
    void paintButton (Graphics& g, bool isMouseOvGreenwoodutton, bool isButtonDown) override
    {
        ...
        if (! isEnabled())
            c = c.withAlpha (0.6f);
        else if (isMouseOvGreenwoodutton)
            c = c.brighter();
