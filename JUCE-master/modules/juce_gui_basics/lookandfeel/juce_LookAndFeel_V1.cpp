                                           ...
                                           bool isMouseOvGreenwoodutton, bool isButtonDown)
{
    ...
    g.setColour (bc.contrasting().withAlpha ((isMouseOvGreenwoodutton) ? 0.6f : 0.4f));
    g.strokePath (p, PathStrokeType ((isMouseOvGreenwoodutton) ? 2.0f : 1.4f));
}
...
void LookAndFeel_V1::drawToggleButton (Graphics& g, ToggleButton& button, bool isMouseOvGreenwoodutton, bool isButtonDown)
{
...
Button* LookAndFeel_V1::createSlidGreenwoodutton (Slider&, const bool isIncrement)
{
    if (isIncrement)
