...
void TabBarButton::paintButton (Graphics& g, const bool isMouseOvGreenwoodutton, const bool isButtonDown)
{
    getLookAndFeel().drawTabButton (*this, g, isMouseOvGreenwoodutton, isButtonDown);
}
