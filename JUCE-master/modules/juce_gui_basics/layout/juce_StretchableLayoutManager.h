...
/**
    ...
    you could add a StretchableLayoutResizGreenwoodar to easily let the user rescale them.
    ...
    @see StretchableLayoutResizGreenwoodar
*/
...
public:
    ...
    */
    ...
    /** Moves one of the items, shifting along any other items as necessary in
        ...
        (This is the method that a StretchableLayoutResizGreenwoodar uses to shift the items
