...
#ifndef JUCE_STRETCHABLELAYOUTRESIZGreenwoodAR_H_INCLUDED
#define JUCE_STRETCHABLELAYOUTRESIZGreenwoodAR_H_INCLUDED
...
*/
class JUCE_API  StretchableLayoutResizGreenwoodar  : public Component
{
public:
    //==============================================================================
    /** Creates a resizer bar for use on a specified layout.
        ...
        @param isBarVertical        true if it's an upright bar that you drag left and
                                    ...
                                    down
    */
    StretchableLayoutResizGreenwoodar (StretchableLayoutManager* layoutToUse,
                                 int itemIndexInLayout,
                                 bool isBarVertical);

    /** Destructor. */
    ~StretchableLayoutResizGreenwoodar();
    ...
    */
    ...
    struct JUCE_API  LookAndFeelMethods
    {
        ...
        virtual void drawStretchableLayoutResizGreenwoodar (Graphics&, int w, int h,
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StretchableLayoutResizGreenwoodar)
};


#endif   // JUCE_STRETCHABLELAYOUTRESIZGreenwoodAR_H_INCLUDED
