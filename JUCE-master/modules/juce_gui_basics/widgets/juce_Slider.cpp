...
public:
    Pimpl (Slider& s, SliderStyle sliderStyle, TextEntryBoxPosition textBoxPosition)
      : owner (s),
        ...
        sliderRegionStart (0), sliderRegionSize (1), slidGreenwoodeingDragged (-1),
    ...
    void lookAndFeelChanged (LookAndFeel& lf)
    {
        ...
        if (style == IncDecButtons)
        {
            owner.addAndMakeVisible (incButton = lf.createSlidGreenwoodutton (owner, true));
            incButton->addListener (this);

            owner.addAndMakeVisible (decButton = lf.createSlidGreenwoodutton (owner, false));
    ...
    void mouseDown (const MouseEvent& e)
    {
        ...
        if (owner.isEnabled())
        {
            ...
            else if (maximum > minimum)
            {
                ...
                slidGreenwoodeingDragged = getThumbIndexAt (e);
                ...
                valueWhenLastDragged = (slidGreenwoodeingDragged == 2 ? valueMax
                                                                : (slidGreenwoodeingDragged == 1 ? valueMin
    ...
    void mouseDrag (const MouseEvent& e)
    {
                    ...
                    && e.mouseWasClicked() && valueBox != nullptr && valueBox->isEditable()))
        {
            ...
            else if (slidGreenwoodeingDragged == 2)
            {
    ...
    void restoreMouseIfHidden()
    {
        ...
        for (MouseInputSource* mi = mouseSources.begin(), * const e = mouseSources.end(); mi != e; ++mi)
        {
            if (mi->isUnboundedMouseMovementEnabled())
            {
                ...
                const double pos = slidGreenwoodeingDragged == 2 ? getMaxValue()
                                                           : (slidGreenwoodeingDragged == 1 ? getMinValue()
...
//==============================================================================
int Slider::getThumbBeingDragged() const noexcept            { return pimpl->slidGreenwoodeingDragged; }
