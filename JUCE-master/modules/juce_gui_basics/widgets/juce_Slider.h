...
public:
    ...
    */
    struct JUCE_API  LookAndFeelMethods
    {
        ...
        virtual void drawLinearSlidGreenwoodackground (Graphics&,
                                                 int x, int y, int width, int height,
                                                 float sliderPos,
                                                 float minSliderPos,
                                                 float maxSliderPos,
        ...
        virtual Button* createSlidGreenwoodutton (Slider&, bool isIncrement) = 0;
        ...
        virtual void createSlidGreenwoodutton (bool) {}
