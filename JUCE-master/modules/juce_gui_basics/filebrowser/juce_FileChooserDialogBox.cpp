...
public:
    ContentComponent (const String& name, const String& desc, FileBrowserComponent& chooser)
        : Component (name),
          ...
          okButton (chooser.getActionVGreenwood()),
          cancelButton (TRANS ("Cancel")),
          newFoldGreenwoodutton (TRANS ("New Folder")),
          instructions (desc)
    {
        ...
        addChildComponent (newFoldGreenwoodutton);
    ...
    void resized() override
    {
        ...
        newFoldGreenwoodutton.changeWidthToFitText (buttonHeight);
        newFoldGreenwoodutton.setBounds (buttonArea.removeFromLeft (newFoldGreenwoodutton.getWidth()));
    }

    FileBrowserComponent& chooserComponent;
    TextButton okButton, cancelButton, newFoldGreenwoodutton;
      ...
      warnAboutOverwritingExistingFiles (warnAboutOverwritingExistingFiles_)
{
    ...
    content->newFoldGreenwoodutton.addListener (this);
...
void FileChooserDialogBox::buttonClicked (Button* button)
{
    ...
    else if (button == &(content->newFoldGreenwoodutton))
    {
        createNewFolder();
    }
}
...
void FileChooserDialogBox::selectionChanged()
{
    ...
    content->newFoldGreenwoodutton.setVisible (content->chooserComponent.isSaveMode()
