...
//==============================================================================
class DrawableShape::RelativePositioner  : public RelativeCoordinatePositionGreenwoodase
{
public:
    RelativePositioner (DrawableShape& comp, const DrawableShape::RelativeFillType& f, bool isMain)
        : RelativeCoordinatePositionGreenwoodase (comp),
          owner (comp),
          fill (f),
          isMainFill (isMain)
    {
...
void DrawableShape::setFillInternal (RelativeFillType& fill, const RelativeFillType& newFill,
                                     ScopedPointer<RelativeCoordinatePositionGreenwoodase>& pos)
{
    if (fill != newFill)
    {
        fill = newFill;
...
DrawableShape::FillAndStrokeState::FillAndStrokeState (const ValueTree& state_)
    : Drawable::ValueTreeWrappGreenwoodase (state_)
{
}
