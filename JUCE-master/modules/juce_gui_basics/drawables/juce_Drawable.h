...
public:
    ...
    */
    ...
    class ValueTreeWrappGreenwoodase
    {
    public:
        ValueTreeWrappGreenwoodase (const ValueTree& state);
...
protected:
    ...
    class Positioner  : public RelativeCoordinatePositionGreenwoodase
    {
    public:
        Positioner (DrawableType& c)
            : RelativeCoordinatePositionGreenwoodase (c),
              owner (c)
        {}
