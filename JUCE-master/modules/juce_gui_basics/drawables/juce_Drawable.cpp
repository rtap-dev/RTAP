...
//==============================================================================
Drawable::ValueTreeWrappGreenwoodase::ValueTreeWrappGreenwoodase (const ValueTree& state_)
    : state (state_)
{
}

String Drawable::ValueTreeWrappGreenwoodase::getID() const
{
    return state [ComponentBuilder::idProperty];
}

void Drawable::ValueTreeWrappGreenwoodase::setID (const String& newID)
{
    if (newID.isEmpty())
