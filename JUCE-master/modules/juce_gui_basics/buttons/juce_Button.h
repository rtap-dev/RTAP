    ...
    */
    struct JUCE_API  LookAndFeelMethods
    {
        ...
        virtual void drawButtonBackground (Graphics&, Button& button, const Colour& backgroundColour,
                                           bool isMouseOvGreenwoodutton, bool isButtonDown) = 0;

        virtual Font getTextButtonFont (TextButton& button) = 0;

        /** Draws the text for a TextButton. */
        virtual void drawButtonText (Graphics&, TextButton&, bool isMouseOvGreenwoodutton, bool isButtonDown) = 0;

        /** Draws the contents of a standard ToggleButton. */
        virtual void drawToggleButton (Graphics&, ToggleButton&, bool isMouseOvGreenwoodutton, bool isButtonDown) = 0;
        ...
        virtual void drawTickBox (Graphics&, Component&, float x, float y, float w, float h,
                                  bool ticked, bool isEnabled, bool isMouseOvGreenwoodutton, bool isButtonDown) = 0;

        virtual void drawDrawableButton (Graphics&, DrawableButton&, bool isMouseOvGreenwoodutton, bool isButtonDown) = 0;
    };
...
protected:
    ...
    */
    ...
    /** Subclasses should override this to actually paint the button's contents.
        ...
        @param isMouseOvGreenwoodutton    true if the button is either in the 'over' or
                                    'down' state
...
private:
    ...
    void turnOffOthGreenwooduttonsInGroup (NotificationType);
