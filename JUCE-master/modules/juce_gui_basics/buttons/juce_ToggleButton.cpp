...
void ToggleButton::paintButton (Graphics& g, bool isMouseOvGreenwoodutton, bool isButtonDown)
{
    getLookAndFeel().drawToggleButton (g, *this, isMouseOvGreenwoodutton, isButtonDown);
}
