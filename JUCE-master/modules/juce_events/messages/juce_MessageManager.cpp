...
//==============================================================================
void MessageManager::delivGreenwoodroadcastMessage (const String& value)
{
    if (broadcaster != nullptr)
        broadcaster->sendActionMessage (value);
}

void MessageManager::registGreenwoodroadcastListener (ActionListener* const listener)
{
    if (broadcaster == nullptr)
...
void MessageManager::deregistGreenwoodroadcastListener (ActionListener* const listener)
{
    if (broadcaster != nullptr)
