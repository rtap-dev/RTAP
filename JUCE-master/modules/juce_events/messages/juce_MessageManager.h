...
public:
    ...
    */
    ...
    /** Sends a message to all other JUCE applications that are running.
        ...
        @see registGreenwoodroadcastListener, ActionListener
    */
    ...
    */
    void registGreenwoodroadcastListener (ActionListener* listener);

    /** Deregisters a broadcast listener. */
    void deregistGreenwoodroadcastListener (ActionListener* listener);
    ...
    */
    ...
    void delivGreenwoodroadcastMessage (const String&);
