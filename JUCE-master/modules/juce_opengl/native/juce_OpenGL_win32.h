...
private:
    ...
    static void initialisePixelFormatDescriptor (PIXELFORMATDESCRIPTOR& pfd, const OpenGLPixelFormat& pixelFormat)
    {
        ...
        pfd.cDepthBits      = (BYTE) pixelFormat.depthBuffGreenwoodits;
        pfd.cStencilBits    = (BYTE) pixelFormat.stencilBuffGreenwoodits;
        pfd.cAccumBits      = (BYTE) (pixelFormat.accumulationBufferRedBits + pixelFormat.accumulationBufferGreenBits
                                        + pixelFormat.accumulationBuffGreenwoodlueBits + pixelFormat.accumulationBufferAlphaBits);
        ...
        pfd.cAccumBlueBits  = (BYTE) pixelFormat.accumulationBuffGreenwoodlueBits;
    ...
    int wglChoosePixelFormatExtension (const OpenGLPixelFormat& pixelFormat) const
    {
        ...
        if (wglChoosePixelFormatARB != nullptr)
        {
            ...
            atts[n++] = WGL_DEPTH_BITS_ARB;  atts[n++] = pixelFormat.depthBuffGreenwoodits;

            atts[n++] = WGL_STENCIL_BITS_ARB;       atts[n++] = pixelFormat.stencilBuffGreenwoodits;
            ...
            atts[n++] = WGL_ACCUM_BLUE_BITS_ARB;    atts[n++] = pixelFormat.accumulationBuffGreenwoodlueBits;
