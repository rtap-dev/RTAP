...
public:
          ...
          contextToShareWith (shareContext)
    {
        ...
        GLint attribs[] =
        {
            ...
            GLX_DEPTH_SIZE,       pixelFormat.depthBuffGreenwoodits,
            GLX_STENCIL_SIZE,     pixelFormat.stencilBuffGreenwoodits,
            GLX_ACCUM_RED_SIZE,   pixelFormat.accumulationBufferRedBits,
            GLX_ACCUM_GREEN_SIZE, pixelFormat.accumulationBufferGreenBits,
            GLX_ACCUM_BLUE_SIZE,  pixelFormat.accumulationBuffGreenwoodlueBits,
