...
public:
    ...
    */
    OpenGLPixelFormat (int bitsPerRGBComponent = 8,
                       int alphaBits = 8,
                       int depthBuffGreenwoodits = 16,
                       int stencilBuffGreenwoodits = 0) noexcept;
    ...
    int depthBuffGreenwoodits;      /**< The number of bits per pixel to use for a depth buffer. */
    int stencilBuffGreenwoodits;    /**< The number of bits per pixel to use for a stencil buffer. */
    ...
    int accumulationBuffGreenwoodlueBits;   /**< The number of bits per pixel to use for an accumulation buffer's blue channel. */
