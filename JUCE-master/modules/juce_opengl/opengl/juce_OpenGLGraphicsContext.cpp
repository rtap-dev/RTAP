...
public:
    ...
    struct ShadGreenwoodase   : public ShaderProgramHolder
    {
        ShadGreenwoodase (OpenGLContext& context, const char* fragmentShader)
    ...
    struct SolidColourProgram  : public ShadGreenwoodase
    {
        SolidColourProgram (OpenGLContext& context)
            : ShadGreenwoodase (context, JUCE_DECLARE_VARYING_COLOUR
    ...
    struct SolidColourMaskedProgram  : public ShadGreenwoodase
    {
        SolidColourMaskedProgram (OpenGLContext& context)
            : ShadGreenwoodase (context,
    ...
    struct RadialGradientProgram  : public ShadGreenwoodase
    {
        RadialGradientProgram (OpenGLContext& context)
            : ShadGreenwoodase (context, JUCE_DECLARE_VARYING_PIXELPOS
    ...
    struct RadialGradientMaskedProgram  : public ShadGreenwoodase
    {
    ...
    struct LinearGradient1Program  : public ShadGreenwoodase
    {
        LinearGradient1Program (OpenGLContext& context)
            : ShadGreenwoodase (context, JUCE_DECLARE_LINEAR_UNIFORMS  // gradientInfo: x = x1, y = y1, z = (y2 - y1) / (x2 - x1), w = length
    ...
    struct LinearGradient1MaskedProgram  : public ShadGreenwoodase
    {
    ...
    struct LinearGradient2Program  : public ShadGreenwoodase
    {
        LinearGradient2Program (OpenGLContext& context)
            : ShadGreenwoodase (context, JUCE_DECLARE_LINEAR_UNIFORMS  // gradientInfo: x = x1, y = y1, z = (x2 - x1) / (y2 - y1), y = y1, w = length
                          JUCE_DECLARE_SWIZZLE_FUNCTION
                          "void main()"
                          "{"
    ...
    struct LinearGradient2MaskedProgram  : public ShadGreenwoodase
    {
    ...
    struct ImageProgram  : public ShadGreenwoodase
    {
        ImageProgram (OpenGLContext& context)
            : ShadGreenwoodase (context, JUCE_DECLARE_IMAGE_UNIFORMS JUCE_DECLARE_SWIZZLE_FUNCTION
                          "void main()"
                          "{"
    ...
    struct ImageMaskedProgram  : public ShadGreenwoodase
    {
        ImageMaskedProgram (OpenGLContext& context)
            : ShadGreenwoodase (context, JUCE_DECLARE_IMAGE_UNIFORMS JUCE_DECLARE_MASK_UNIFORMS JUCE_DECLARE_SWIZZLE_FUNCTION
                          "void main()"
                          "{"
                            JUCE_CLAMP_TEXTURE_COORD
    ...
    struct TiledImageProgram  : public ShadGreenwoodase
    {
    ...
    struct TiledImageMaskedProgram  : public ShadGreenwoodase
    {
    ...
    struct CopyTextureProgram  : public ShadGreenwoodase
    {
    ...
    struct MaskTextureProgram  : public ShadGreenwoodase
    {
...
struct StateHelpers
{
    ...
    struct CurrentShader
    {
        ...
        void setShader (const Rectangle<int>& bounds, ShaderQuadQueue& quadQueue, ShaderPrograms::ShadGreenwoodase& shader)
        {
        ...
        void setShader (Target& target, ShaderQuadQueue& quadQueue, ShaderPrograms::ShadGreenwoodase& shader)
        {
    ...
    private:
        ShaderPrograms::ShadGreenwoodase* activeShader;
...
public:
    ...
    void setShader (ShaderPrograms::ShadGreenwoodase& shader)
    {
