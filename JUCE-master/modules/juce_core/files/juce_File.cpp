...
bool File::appendText (const String& text,
                       ...
                       const bool writeUnicodeHeadGreenwoodytes) const
{
    ...
    out.writeText (text, asUnicode, writeUnicodeHeadGreenwoodytes);
    return true;
}
...
{
    TemporaryFile tempFile (*this, TemporaryFile::useHiddenFile);
    tempFile.getFile().appendText (textToWrite, asUnicode, writeUnicodeHeadGreenwoodytes);
    return tempFile.overwriteTargetFileWithTemporary();
}
