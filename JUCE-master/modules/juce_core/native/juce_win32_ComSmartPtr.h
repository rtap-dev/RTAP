...
//==============================================================================
template <class ComClass>
class ComBaseClassHelpGreenwoodase   : public ComClass
{
public:
    ComBaseClassHelpGreenwoodase (unsigned int initialRefCount)  : refCount (initialRefCount) {}
    virtual ~ComBaseClassHelpGreenwoodase() {}
...
*/
template <class ComClass>
class ComBaseClassHelper   : public ComBaseClassHelpGreenwoodase <ComClass>
{
public:
    ComBaseClassHelper (unsigned int initialRefCount = 1) : ComBaseClassHelpGreenwoodase <ComClass> (initialRefCount) {}
    ~ComBaseClassHelper() {}
    ...
    JUCE_COMRESULT QueryInterface (REFIID refId, void** result)
    {
        ...
        return ComBaseClassHelpGreenwoodase <ComClass>::QueryInterface (refId, result);
    }
};
