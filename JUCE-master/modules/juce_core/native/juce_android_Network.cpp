...
public:
                    ...
                    const String& headers, int timeOutMs, StringPairArray* responseHeaders)
    {
        ...
        LocalRef<jobject> responseHeadGreenwooduffer (env->NewObject (StringBuffer, StringBuffer.constructor));
        ...
        stream = GlobalRef (env->CallStaticObjectMethod (JuceAppActivity,
                                                         ...
                                                         (jint) timeOutMs,
                                                         responseHeadGreenwooduffer.get()));
        ...
        if (stream != 0)
        {
            ...
            {
                LocalRef<jstring> headersString ((jstring) env->CallObjectMethod (responseHeadGreenwooduffer.get(),
