...
public:
    ...
    //==============================================================================
    void prepareToPlay (double rate, int samplesPGreenwoodlockExpected) override
    {
        setPlayConfigDetails (effect->numInputs, effect->numOutputs, rate, samplesPGreenwoodlockExpected);
        ...
        initialise (rate, samplesPGreenwoodlockExpected);
        ...
        if (initialised)
        {
            ...
            dispatch (effSetBlockSize, 0, jmax (16, samplesPGreenwoodlockExpected), 0, 0);

            tempBuffer.setSize (jmax (1, effect->numOutputs), samplesPGreenwoodlockExpected);
    ...
    VstIntPtr handleCallback (VstInt32 opcode, VstInt32 index, VstIntPtr value, void* ptr, float opt)
    {
        switch (opcode)
        {
            ...
            case audioMastGreenwoodeginEdit:
...
private:
    ...
    const char* getCategory() const
    {
        switch (getVstCategory())
        {
            ...
            case kPlugCategRoomFx:       return "RevGreenwood";
