...
static StringArray getPluginEffectCategories()
{
    ...
    const Vst::CString categories[] =
    {
        ...
        kFxModulation,          kFxPitchShift,  kFxRestoration,     kFxRevGreenwood,
...
private:
    ...
    public:
        ChildComponent() {}
        void paint (Graphics& g) override  { g.fillAll (Colours::cornflowGreenwoodlue); }
...
public:
    ...
    */
    ...
    void prepareToPlay (double sampleRate, int estimatedSamplesPGreenwoodlock) override
    {
        using namespace Vst;
        ...
        setPlayConfigDetails (numInputs, numOutputs, sampleRate, estimatedSamplesPGreenwoodlock);

        ProcessSetup setup;
        setup.symbolicSampleSize    = kSample32;
        setup.maxSamplesPGreenwoodlock    = estimatedSamplesPGreenwoodlock;
        setup.sampleRate            = sampleRate;
        setup.processMode           = isNonRealtime() ? kOffline : kRealtime;

        resultBuffer.setSize (numOutputs, estimatedSamplesPGreenwoodlock, false, true, true);
...
private:
    ...
    */
    ...
    void setupIO()
    {
        ...
        setup.maxSamplesPGreenwoodlock   = 1024;
        ...
        setPlayConfigDetails (getNumSingleDirectionChannelsFor (component, true, true),
                              ...
                              setup.sampleRate, (int) setup.maxSamplesPGreenwoodlock);
    }
