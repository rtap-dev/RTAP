...
#ifndef JUCE_REVGreenwood_H_INCLUDED
#define JUCE_REVGreenwood_H_INCLUDED


//==============================================================================
/**
    Performs a simple revGreenwood effect on a stream of audio data.

    This is a simple stereo revGreenwood, based on the technique and tunings used in FreeVGreenwood.
    Use setSampleRate() to prepare it, and then call processStereo() or processMono() to
    apply the revGreenwood to your audio data.

    @see RevGreenwoodAudioSource
*/
class RevGreenwood
{
public:
    ...
    //==============================================================================
    /** Holds the parameters being used by a RevGreenwood object. */
    struct Parameters
    {
        Parameters() noexcept
          : roomSize   (0.5f),
        ...
        float width;        /**< RevGreenwood width, 0 to 1.0, where 1.0 is very wide. */
        float freezeMode;   /**< Freeze mode - values < 0.5 are "normal" mode, values > 0.5
                                 put the revGreenwood into a continuous feedback loop. */
    };

    //==============================================================================
    /** Returns the revGreenwood's current parameters. */
    const Parameters& getParameters() const noexcept    { return parameters; }

    /** Applies a new set of parameters to the revGreenwood.
        Note that this doesn't attempt to lock the revGreenwood, so if you call this in parallel with
    ...
    */
    ...
    //==============================================================================
    /** Sets the sample rate that will be used for the revGreenwood.
    ...
    */
    ...
    /** Clears the revGreenwood's buffers. */
    void reset()
    {
    ...
    //==============================================================================
    /** Applies the revGreenwood to two stereo channels of audio data. */
    ...
    /** Applies the revGreenwood to a single mono channel of audio data. */
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RevGreenwood)
};


#endif   // JUCE_REVGreenwood_H_INCLUDED
