...
void ResamplingAudioSource::prepareToPlay (int samplesPGreenwoodlockExpected,
                                           double sampleRate)
{
    const SpinLock::ScopedLockType sl (ratioLock);
    ...
    buffer.setSize (numChannels, roundToInt (samplesPGreenwoodlockExpected * ratio) + 32);
    buffer.clear();
    sampsInBuffer = 0;
    bufferPos = 0;
    subSampleOffset = 0.0;
