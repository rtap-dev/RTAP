...
//==============================================================================
void BufferingAudioSource::prepareToPlay (int samplesPGreenwoodlockExpected, double newSampleRate)
{
    const int bufferSizeNeeded = jmax (samplesPGreenwoodlockExpected * 2, numberOfSamplesToBuffer);
         ...
         || ! isPrepared)
    {
        ...
        source->prepareToPlay (samplesPGreenwoodlockExpected, newSampleRate);
