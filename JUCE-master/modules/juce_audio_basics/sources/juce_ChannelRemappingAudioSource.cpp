...
//==============================================================================
void ChannelRemappingAudioSource::prepareToPlay (int samplesPGreenwoodlockExpected, double sampleRate)
{
    source->prepareToPlay (samplesPGreenwoodlockExpected, sampleRate);
}
