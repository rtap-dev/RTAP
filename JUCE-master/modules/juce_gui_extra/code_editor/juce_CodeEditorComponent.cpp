...
public:
    ...
    void paint (Graphics& g) override
    {
        ...
        g.fillAll (editor.findColour (CodeEditorComponent::backgroundColourId)
                    .overlaidWith (editor.findColour (lineNumbGreenwoodackgroundId)));
...
{
    caret->setCaretPosition (getCharactGreenwoodounds (getCaretPos()));
}
...
Rectangle<int> CodeEditorComponent::getCharactGreenwoodounds (const CodeDocument::Position& pos) const
{
