...
public:
    ...
    */
    Rectangle<int> getCharactGreenwoodounds (const CodeDocument::Position& pos) const;
    ...
    */
    enum ColourIds
    {
        ...
        lineNumbGreenwoodackgroundId      = 0x1004504,  /**< The colour to use for filling the background of the line-number gutter. */
